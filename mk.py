...
def Tele(ccx):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..m9X-9jnutQk8j6kixgLaSU5zD7xYKudzl5-EhaIdoHx6Zc55Eg5dYn3uy8UflrIovPhjnkwi5ri3nXJbE6x1iA',
...
#data = '{"clientSdkMetadata":{"source":"client","integration":"custom","sessionId":"379f0177-032a-47fd-9e6a-56561cd41a24"},"query":"mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       cardholderName       expirationMonth      expirationYear      binData {         prepaid         healthcare         debit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }","variables":{"input":{"creditCard":{"number":"5115581818109910","expirationMonth":"06","expirationYear":"2025","cvv":"291"},"options":{"validate":false}}},"operationName":"TokenizeCreditCard"}'
#response = requests.post('https://payments.braintree-api.com/graphql', headers=headers, data=data)
    ...
    'sbjs_udata': 'vst%3D11%7C%7C%7Cuip%3D%28none%29%7C%7C%7Cuag%3DMozilla%2F5.0%20%28Linux%3B%20Android%2010%3B%20K%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F124.0.0.0%20Mobile%20Safari%2F537.36',
    'sbjs_session': 'pgs%3D2%7C%7C%7Ccpg%3Dhttps%3A%2F%2Fce4less.com%2Fmy-account%2Fadd-payment-method%2F',
    '_uetsid': 'cc9ad4a02b4411ef8ff77f5b1d793947',
    '_uetvid': 'b873acf0261211efa5545d92dac21af2',
    '_ga_JVCGZDD7ML': 'GS1.1.1718475996.11.0.1718475996.60.0.1977330465',
}
    ...
    'woocommerce-add-payment-method-nonce': '3cc96dcfa8',
